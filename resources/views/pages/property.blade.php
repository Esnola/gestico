<x-layouts.public title="Administración de fincas">
    <section class="bg-brand-mist py-16 dark:bg-brand-night sm:py-20">
        <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <p class="text-sm font-normal uppercase tracking-[0.04em] text-brand-gold dark:text-brand-night-gold">Administración de fincas</p>
            <h1 class="mt-4 max-w-4xl font-gestico-serif text-4xl font-semibold leading-tight sm:text-5xl">Administración pensada para resolver el día a día de la comunidad.</h1>
            <p class="mt-6 max-w-3xl text-lg leading-6 text-brand-text-muted dark:text-brand-night-muted">Trabajamos para que la gestión esté ordenada, los acuerdos avancen y la comunidad tenga una referencia clara cuando surgen dudas, incidencias o decisiones que no pueden esperar.</p>
    ...
    <section class="bg-white py-16 dark:bg-brand-night-panel">
        <div class="mx-auto grid max-w-7xl gap-8 px-5 sm:px-6 lg:grid-cols-[1.05fr_.95fr] lg:px-8">
            <div>
                ...
                <h2 class="mt-4 font-gestico-serif text-3xl font-semibold text-brand-ink dark:text-brand-night-text sm:text-4xl">La comunidad necesita alguien que ordene, explique y proporcione seguimiento.</h2>
                <p class="mt-5 leading-7 text-brand-text-muted dark:text-brand-night-muted">La administración de fincas no es solo tramitar papeles. También es interpretar los acuerdos de la junta, coordinar proveedores, avisar a tiempo de los plazos y mantener una relación clara entre vecinos, presidencia y comunidad.</p>
            ...
            <div class="grid gap-5">
                @foreach ([
                    ...
                    <article class="rounded-md border border-brand-border bg-brand-surface p-6 dark:border-brand-night-border dark:bg-brand-night-raised">
    ...
    <section class="bg-brand-cream py-16 dark:bg-brand-night">
        <div class="mx-auto grid max-w-7xl gap-8 px-5 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
            <div>
                <p class="text-sm font-normal uppercase tracking-[0.04em] text-brand-gold dark:text-brand-night-gold">Situaciones habituales</p>
                <h2 class="mt-4 font-gestico-serif text-3xl font-semibold text-brand-ink dark:text-brand-night-text sm:text-4xl">La administración aporta más valor cuando hay problemas que no conviene dejar para después.</h2>
                <p class="mt-5 leading-7 text-brand-text-muted dark:text-brand-night-muted">Cada comunidad tiene momentos en los que necesita apoyo más allá del trámite básico: una obra que se complica, un recibo pendiente, un siniestro, un vecino que necesita respuestas o una junta que exige claridad y orden.</p>
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                @foreach ([
                    ...
                    <article class="rounded-md border border-brand-border-warm bg-brand-surface p-5 dark:border-brand-night-border dark:bg-brand-night-raised">
        ...
        <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div class="rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                ...
                <div class="mt-5 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
                    <div>
                        <h2 class="font-gestico-serif text-3xl font-semibold leading-tight sm:text-4xl">La comunidad gana estabilidad cuando los asuntos tienen seguimiento y la información no se pierde.</h2>
                        <p class="mt-4 max-w-2xl text-lg leading-7 text-brand-frost">Nuestro objetivo es que vecinos y presidentes tengan una administración más previsora, más clara y más fácil de consultar cuando surge una duda o una decisión urgente.</p>
                    </div>
                    <div class="flex flex-col gap-3 sm:flex-row lg:justify-end">
                        <a href="{{ route('contact') }}" class="inline-flex justify-center rounded-md bg-brand-gold-bright px-6 py-3 text-sm font-normal text-brand-ink transition hover:bg-brand-gold-soft dark:bg-brand-night-gold dark:text-brand-night">Solicitar información</a>
