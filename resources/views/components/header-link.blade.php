...
<a @class([
    ...
    'flex items-center gap-3 bg-brand-surface px-4 py-3 text-brand-text hover:bg-brand-surface-warm hover:text-brand-gold dark:bg-brand-night-panel dark:text-brand-night-muted dark:hover:bg-brand-night-surface dark:hover:text-brand-night-gold' => $variant === 'mobile',
