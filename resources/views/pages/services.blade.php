<x-layouts.public title="Servicios">
    <section class="bg-[#eef1ec] py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <p class="text-sm font-bold uppercase text-[#a98211]">Servicios</p>
            <h1 class="mt-4 max-w-4xl text-4xl font-black leading-tight text-[#1f3336] sm:text-5xl">Gestión integral para comunidades que quieren funcionar con menos fricción.</h1>
