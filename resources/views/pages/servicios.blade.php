    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
      <div class="rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
        ...
        <div class="mt-5 grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            <h2 class="font-gestico-serif text-3xl font-semibold leading-tight sm:text-4xl">La transparencia importa
              tanto como la gestión.</h2>
            <p class="mt-4 max-w-2xl text-lg leading-7 text-brand-frost">Por eso trabajamos con información ordenada,
              respuestas comprensibles y una estructura preparada para que la comunidad pueda consultar lo importante
              sin perder tiempo.</p>
          </div>
