<x-layouts.public title="Asesoría económico-financiera, fiscal y laboral">
    <section class="bg-brand-mist py-16 dark:bg-brand-night sm:py-20">
        <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            ...
            <h1 class="mt-4 max-w-4xl font-gestico-serif text-4xl font-semibold leading-tight text-brand-ink dark:text-brand-night-text sm:text-5xl">Cuentas, impuestos y obligaciones laborales bajo control.</h1>
            <p class="mt-6 max-w-3xl text-lg leading-8 text-brand-text-muted dark:text-brand-night-muted">La parte económica de una comunidad necesita precisión, calendario y explicaciones comprensibles. Integramos contabilidad, bancos, fiscalidad y gestión laboral en un mismo flujo.</p>
        </div>
    </section>
